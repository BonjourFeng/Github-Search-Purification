...
(function () {
    ...
    let showBlockConfirm = GM_getValue("showBlockConfirm", true); // 是否在block用户时弹窗确定，默认为true
    ...
    function openMenu() {
        ...
        if (document.getElementsByClassName("settings").length == 0) {
            ...
            settingMenu.innerHTML = /*html*/`
                ...
                <div class="settings-block">
                    <span>(Loop模式)每次检测循环间隔的时间 (毫秒) ：</span>
                    <input type="number" class="settings-input">
                </div>
                <div class="settings-block">
                    <span>是否在block用户时弹窗确定:</span>
                    <label class="settings-switch">
                        <input type="checkbox" id="showBlockConfirm">
            ...
            showBlockConfirm ? document.getElementById("showBlockConfirm").checked = true : document.getElementById("showBlockConfirm").checked = false;
            ...
            document.getElementById("save").onclick = function () {
                ...
                document.getElementById("showBlockConfirm").checked == true ? GM_setValue("showBlockConfirm", true) : GM_setValue("showBlockConfirm", false);
        ...
        function processResultList(resultList) {
            ...
            for (let i = 0; i < repos.length; i++) {
                ...
                const blockButton = createElement('button', exampleButton.className, {
                    innerText: '🚫Block',
                    onclick: () => {
                        if (showBlockConfirm ? confirm("确定要屏蔽此用户: " + user + " 吗？") : true) {
                ...
                blockButton.setAttribute('data-variant', 'default');
